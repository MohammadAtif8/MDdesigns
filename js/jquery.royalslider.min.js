...
(function (n) {
    function v(b, f) {
        ...
        a._b1 = 3 > a.numSlides ? a.numSlides : 3;
        a._c1 = 0;
        a._d1 = 0;
        a.slidesJQ = [];
        ...
        a.pointerEnabled
            ? ((a.hasTouch = !1), (a._n1 = 0.2), (a.pointerMultitouch = Boolean(1 < e[(c ? "m" : "msM") + "axTouchPoints"])), c ? k("pointer", "down", "move", "up", "cancel") : k("MSPointer", "Down", "Move", "Up", "Cancel"))
            : (a.isIOS ? (a._j1 = a._k1 = a._l1 = a._m1 = "") : k("mouse", "down", "move", "up"),
              "ontouchstart" in window || "createTouch" in document
                  ? ((a.hasTouch = !0), (a._j1 += " touchstart" + m), (a._k1 += " touchmove" + m), (a._l1 += " touchend" + m), (a._m1 += " touchcancel" + m), (a._n1 = 0.5), a.st.sliderTouch && (a._f1 = !0))
                  : ((a.hasTouch = !1), (a._n1 = 0.2)));
        a.st.sliderDrag &&
            ((a._f1 = !0),
            h.msie || h.opera ? (a._g1 = a._h1 = "move") : h.mozilla ? ((a._g1 = "-moz-grab"), (a._h1 = "-moz-grabbing")) : h.webkit && -1 != e.platform.indexOf("Mac") && ((a._g1 = "-webkit-grab"), (a._h1 = "-webkit-grabbing")),
            a._i1());
        a.slider.html(d);
        ...
        a._e
            ? ((a._t1 = "transition-property"),
              ...
              a._f ? (h.webkit && !h.chrome && a.slider.addClass("rsWebkit3d"), (a._y1 = "translate3d("), (a._z1 = "px, "), (a._a2 = "px, 0px)")) : ((a._y1 = "translate("), (a._z1 = "px, "), (a._a2 = "px)")),
              a._l ? (a._p1[a._g + a._t1] = a._g + "transform") : ((h = {}), (h[a._g + a._t1] = "opacity"), (h[a._g + a._u1] = a.st.transitionSpeed + "ms"), (h[a._g + a._v1] = a.st.css3easeInOut), e.css(h)))
        ...
        _k3: function (b, f) {
            if (this._l3) {
                ...
                f
                    ...
                    : this._z || (0 >= this.currSlideId && 0 < d - this._d3 && (g = this._h3 + a * this._n1), this.currSlideId >= this.numSlides - 1 && 0 > d - this._d3 && (g = this._h3 + a * this._n1));
                this._h3 = g;
                        ...
                        if (f) {
                            ...
                            (l = function (a) {
                                ...
                                p + q < m
                                    ? 0 > w
                                        ? a(!1, d)
                                        : ((l = l(m - p)), e._m2(e.currSlideId - l, c(Math.abs(e._p - (-e._u - e._d1 + l) * e._w) / d), !1, !0, !0))
                                    : p - q > m
                                    ? 0 < w
                                        ? a(!1, d)
                                        : ((l = l(p - m)), e._m2(e.currSlideId + l, c(Math.abs(e._p - (-e._u - e._d1 - l) * e._w) / d), !1, !0, !0))
                                    : a(!1, d);
                    }
                }
        },
            ...
            if (this.slider) {
                if (this.st.autoScaleSlider) {
                    ...
                    this.st.autoScaleHeight
                        ? ((f = this.slider.width()), f != this.width && (this.slider.css("height", (e / a) * f), (f = this.slider.width())), (c = this.slider.height()))
                        : ((c = this.slider.height()), c != this.height && (this.slider.css("width", (a / e) * c), (c = this.slider.height())), (f = this.slider.width()));
...
(function (f) {
    f.extend(f.rsProto, {
        ...
        _k6: function () {
            ...
            a._q6 &&
                ((e += "Arrow"),
                b.arrowLeft ? (a._r6 = b.arrowLeft) : ((a._r6 = f('<div class="' + e + " " + e + 'Left"><div class="' + e + 'Icn"></div></div>')), c.append(a._r6)),
                b.arrowRight ? (a._s6 = b.arrowRight) : ((a._s6 = f('<div class="' + e + " " + e + 'Right"><div class="' + e + 'Icn"></div></div>')), c.append(a._s6)),
        ...
        updateThumbsSize: function (a, e) {
            ...
            b._z3 &&
                ...
                b._y3 < b._z3
                    ? (b.st.thumbs.autoCenter ? b._q3((b._z3 - b._y3) / 2) : b._q3(b._n3),
        ...
        _a4: function (a, e, b, c, g) {
            ...
            if (d._l6) {
                ...
                d._p6 = !0;
                d._e
                    ? ((h[d._g + "transition-duration"] = e + "ms"), (h[d._g + "transition-timing-function"] = b ? f.rsCSS3Easing[d.st.easeOut] : f.rsCSS3Easing[d.st.easeInOut]), d._s3.css(h), d._q3(a))
        ...
        _m6: function (a, e) {
            ...
            this._l6 &&
                ...
                f + this._i3 > this._z3
                    ? (a === this.numSlides - 1 && (b = 1), (d = -a + this._u6 - 2 + b), (c = d * this._t6 + (this._z3 % this._t6) + this._v6 - this._n3))
                    : 0 !== a
                    ? (a - 1) * this._t6 <= -this._i3 + this._n3 && a - 1 <= this.numSlides - this._u6 && (c = (-a + 1) * this._t6 + this._n3)
                    : (c = this._n3),
        ...
        playVideo: function () {
            ...
            if (!a._b7) {
                ...
                d.match(/youtu\.be/i) || d.match(/youtube\.com/i)
                    ? ((e = /^.*((youtu.be\/)|(v\/)|(\/u\/\w\/)|(embed\/)|(watch\?))\??v?=?([^#\&\?]*).*/), (e = d.match(e)) && 11 == e[7].length && (c = e[7]), void 0 !== c && (a._c7 = a.st.video.youTubeCode.replace("%id%", c)))
                    : d.match(/vimeo\.com/i) && ((e = /(www\.)?vimeo.com\/(\d+)($|\/)/), (e = d.match(e)) && (c = e[2]), void 0 !== c && (a._c7 = a.st.video.vimeoCode.replace("%id%", c)));
                a.videoObj = f(a._c7);
                a.ev.trigger("rsOnCreateVideoElement", [d]);
                a.videoObj.length &&
                    ((a._c7 = f('<div class="rsVideoFrameHolder"><div class="rsPreloader"></div><div class="rsCloseVideoBtn"><div class="rsCloseVideoIcn"></div></div></div>')),
                ...
                if (
                    ...
                    a._e
                        ...
                        : (p ? (isNaN(parseInt(b.css("right"), 10)) ? (h = "left") : ((h = "right"), (n = !0))) : isNaN(parseInt(b.css("bottom"), 10)) ? (h = "top") : ((h = "bottom"), (n = !0)),
                          (h = "margin-" + h),
                          n && (c = -c),
                          a._e ? (k = parseInt(b.css(h), 10)) : ((k = b.data("rs-start-move-prop")), void 0 === k && ((k = parseInt(b.css(h), 10)), isNaN(k) && (k = 0), b.data("rs-start-move-prop", k))));
                ...
                var b,
                    ...
                    d = function (d) {
                        ...
                        (b = e.holder) &&
                            ...
                            ((a._c4 = c),
                            a._e || !d ? a._e1.css("height", c) : a._e1.stop(!0, !0).animate({ height: c }, a.st.transitionSpeed),
...
(function (d) {
    d.rsProto._g7 = function () {
        ...
        a.st.visibleNearby &&
            ...
            ((a._h7 = { enabled: !0, centerArea: 0.6, center: !0, breakpoint: 0, breakpointCenterArea: 0.8, hiddenOverflow: !0, navigateByCenterClick: !1 }),
